...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='iscp', help='in-cylinder combustion pressure dataset')
        ...
        self.parser.add_argument('--isize', type=int, default=360, help='input sequence size.')
        ...
        self.parser.add_argument('--data_scaler', default=None, help='data scaler')
        self.opt = None
